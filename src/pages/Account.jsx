...
import { confirmUserEmail } from '../requests/auth';
  ...
  return (
    <>
      ...
      <section className='max-w-7xl mx-auto p-4'>
        ...
        <p className='mt-2 text-[#666e75] text-[16px]'>
          Here you can permanently delete your account. Keep in mind that this
          action is irreversible and will remove all your data from our system.
        </p>
        <form className='mt-8' onSubmit={handleSubmit}>
          <div className='flex flex-col gap-5'>
            <FormField
